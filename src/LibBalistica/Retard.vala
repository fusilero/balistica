...
namespace LibBalistica{
    public class Retard : GLib.Object {
        ...
        internal static double CalcRetard(DragFunction drag_func, double DragCoefficient, double Velocity) {
            ...
            case DragFunction.I:
                if( vp > 2600 ){
                    A = 4.0648825e-03 ; M = 1.55 ;
                } else if( vp > 1800 ){
                    A = 1.2479524e-03 ; M = 1.70 ;
                } else if( vp > 1370 ){
                    A = 1.3160125e-04 ; M = 2.00 ;
                } else if( vp > 1230 ){
                    A = 9.5697809e-08 ; M = 3.00 ;
                } else if( vp > 970 ){
                    A = 6.3368148e-14 ; M = 5.00 ;
                } else if( vp > 790 ){
                    A = 5.9353046e-08 ; M = 3.00 ;
                } else if( vp > 0 ){
                    A = 4.6761777e-05 ; M = 2.00 ;
                }
                break ;
